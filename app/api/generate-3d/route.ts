...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log('Step 2: Starting Meshy preview task...')
    ...
    const preview_task_id: string = (await res.json()).result
    console.log('Preview task ID:', preview_task_id)

    return NextResponse.json({ preview_task_id })
